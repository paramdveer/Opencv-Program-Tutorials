...
#from imutils.perspective import four_point_transform as four_point_transform
...
# birds eye view of the pape
paper = four_point_transform(image, docCnt.reshape(4, 2))
warped = four_point_transform(gray, docCnt.reshape(4, 2))
#*******************************************************************************************************************
cv2.imshow("fourPointTransformed",paper)
...
for c in cnts:
	...
	if w >= 1 and h >= 1 and ar >= 0.1 and ar <= 5:
